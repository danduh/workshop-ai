...
-- Indexes
CREATE UNIQUE INDEX idx_prompts_key_version ON prompts(prompt_key, version);
CREATE UNIQUE INDEX idx_prompts_key_active ON prompts(prompt_key) WHERE is_active = true;
CREATE INDEX idx_prompts_key ON prompts(prompt_key);
CREATE INDEX idx_prompts_model ON prompts(model_name);
